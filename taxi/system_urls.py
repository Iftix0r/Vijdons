...
urlpatterns = [
    ...
    path('bot/client/set-webhook/', views.client_bot_set_webhook, name='client_bot_set_webhook'),
    path('bot/client/webhook-status/', views.client_bot_webhook_status, name='client_bot_webhook_status'),
