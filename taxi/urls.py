...
urlpatterns = [
    ...
    path('drivers/<int:pk>/toggle-frozen/', views.driver_toggle_frozen, name='driver_toggle_frozen'),
    path('drivers/<int:pk>/toggle-qarz/', views.driver_toggle_qarz, name='driver_toggle_qarz'),
    path('drivers/<int:pk>/qarz-note/', views.driver_qarz_update_note, name='driver_qarz_update_note'),
    ...
    path('qarzdorlar/', views.qarzdorlar_list, name='qarzdorlar_list'),
    path('qarzdorlar/export/', views.qarzdorlar_export_csv, name='qarzdorlar_export_csv'),
    ...
    path('goals/<int:pk>/reopen/', views.goal_reopen, name='goal_reopen'),
