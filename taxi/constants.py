...
PANEL_SOUND_EVENTS = [
    ...
    ('panel_order_completed',  '🏁 Buyurtma yakunlandi'),
    ('panel_order_on_way',     "🚗 Haydovchi yo'lda"),
    ('panel_order_arrived',    '📍 Haydovchi yetib keldi'),
    ('panel_driver_registered','🆕 Yangi haydovchi qo\'shildi'),
    ('panel_driver_approved',  '✅ Haydovchi tasdiqlandi'),
...
DRIVER_SOUND_EVENTS = [
    ...
    ('driver_low_balance',     '⚠️ Balans kam (yangi buyurtma qabul qilib bo\'lmaydi)'),
]
