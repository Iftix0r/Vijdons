...
class TariffSettings(models.Model):
    ...
    fairness_max_radius_km = models.FloatField(default=3.0, verbose_name="Adolat radiusi (km)", help_text="Shu radiusdan uzoqdagi haydovchilar avtomatik taqsimlashda umuman ko'rib chiqilmaydi — mijozni ortiqcha kutdirmaslik uchun (adolat mijoz tajribasidan ustun qo'yilmaydi). 0 = cheklovsiz")
