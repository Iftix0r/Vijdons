...
class Driver(models.Model):
    ...
    rating          = models.DecimalField(max_digits=3, decimal_places=2, default=5.0, verbose_name="Reyting (1–5)")
    ...
    push_subscription = models.TextField(null=True, blank=True, verbose_name="Web Push Subscription")
...
class Order(models.Model):
    ...
    tmx_fare      = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, verbose_name="Taximetr narxi")
    tmx_duration  = models.PositiveIntegerField(null=True, blank=True, verbose_name="Taximetr vaqti (sekund)")
