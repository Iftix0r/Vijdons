 ...
 * qo'shadi. Agar javob baribir HTML (JSON emas) bo'lib chiqsa — cookie
 * eskirgan/ishlamagan deb, WebView'ni qayta ishga tushirib, so'rovni bir
 * marta qayta yuboradi.
 */
class ChallengeInterceptor @Inject constructor(private val solver: ChallengeSolver) : Interceptor {
    ...
    private fun proceedWithSession(chain: Interceptor.Chain, session: uz.vijdon.smsgateway.data.challenge.ChallengeSession?): Response {
