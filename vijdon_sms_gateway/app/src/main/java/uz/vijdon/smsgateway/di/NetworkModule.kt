package uz.vijdon.smsgateway.di
...
import uz.vijdon.smsgateway.data.challenge.ChallengeInterceptor
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideSmsGatewayApiService(retrofit: Retrofit): SmsGatewayApiService =
        retrofit.create(SmsGatewayApiService::class.java)
}
