package uz.vijdon.driver.data.challenge
 ...
 * so'rovlarida qayta ishlatish uchun beradi — xuddi call_watcher ilovasi
 * shu sababdan butunlay WebView orqali ishlaganidek, farqi shundaki bu
 * yerda faqat "kalitni olish" uchun bir martalik WebView ishlatiladi,
 * ilovaning qolgan qismi (UI, tarmoq) to'liq native bo'lib qoladi.
 */
@Singleton
class ChallengeSolver @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    private suspend fun solveOnMainThread(): ChallengeSession? {
        ...
        // haydovchini doim rad etardi. Shu sabab WebView'ga haqiqiy o'lcham
