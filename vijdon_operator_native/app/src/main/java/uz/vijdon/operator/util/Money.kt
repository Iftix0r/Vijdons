package uz.vijdon.operator.util
 ...
 * bo'sh joy bilan ajratiladi ("39629" -> "39 629"). `Locale.US` ataylab
 * qo'yilgan — aks holda qurilma tili o'zbek/rus bo'lsa, kasr ajratuvchisi
 * vergul (","), butun ilova esa nuqta (".") kutadi.
 */
